...
<form action="deletePro.jsp?pageNum=<%=request.getParameter("pageNum") %>" method="post" name="fr" onsubmit="return checkdelete();">
<input type="hidden" name="bno" value="<%=request.getParameter("bno") %>" >
  

<table id="notice">
<tr><th class="tno" colspan="5">게시글 삭제</th></tr>
